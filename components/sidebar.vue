	...
	<nav class="sidebar js-sidebar" :class="{ collapsed: isCollapsed }">
		<div class="sidebar-content">
			<nuxt-link to="/" class="sidebar-brand">
				<img src="/assets/img/logo.png" alt="Favicon" class="bi pe-none me-2" width="40" height="40" />
...
const isCollapsed = sidebar.$state.isCollapsed
</script>
...
.sidebar {
	...
	&-item {
		.active {
			color: #e9ecef;
			background: #{linear-gradient(90deg, rgba(#3b7ddd, 0.1) 0%, rgba(#3b7ddd, 0.0875) 50%, rgba(#000, 0) 100%)};
